...
import 'package:bari_bodol/screens/House_post/delete_post.dart';
...
import '../Post_Prediction/machine_learning_post_prediction.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            TextButton(
              onPressed: () {
                Get.to(const PredictionPostPage());
              },
              child: Container(
                width: 130,
                height: 40,
